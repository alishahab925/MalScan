...
- **AI-Powered Reporting**: Utilizes Claude Sonnet 4 to interpret analysis results and generate professional threat reports.
...
4.  **AI Interpreter**: Sends the structured data to Claude Sonnet 4 for behavioral analysis and risk assessment.
